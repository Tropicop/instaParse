...
import com.example.instaparse.fragments.ComposeFragments;
...
//                    Toast.makeText(SecondActivity.this, "Home!", Toast.LENGTH_SHORT).show();
                ...
                case R.id.action_compose:
                    fragment = new ComposeFragments();
//                    Toast.makeText(SecondActivity.this, "Compose!", Toast.LENGTH_SHORT).show();
                    break;
